...
- Current rebuilt artifact in this checkout: 1,665,610 entries, about 77.1 MB.
...
- `static-word-list/fst_classified_headwords.json`: 10,542 directly FST-classified headwords
