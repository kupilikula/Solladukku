...
const computeLetterToIndices = () => {
    ...
    for (
        ...
        consonant_index < TamilLetters.Letters.length;
        consonant_index++
    ) {
        for (
            let vowel_index = 0;
            vowel_index < TamilLetters.Letters[consonant_index].length;
            vowel_index++
        ) {
            letterToIndices[TamilLetters.Letters[consonant_index][vowel_index]] = [
                consonant_index,
                vowel_index,
            ];
        }
